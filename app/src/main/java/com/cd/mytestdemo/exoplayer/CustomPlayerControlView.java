 ...
 *         <li>Default: {@link CustomPlayerControlView#DEFAULT_REPEAT_TOGGLE_MODES}
 *       </ul>
...
public class CustomPlayerControlView extends FrameLayout {
  ...
  public CustomPlayerControlView(
          final Context context, AttributeSet attrs, int defStyleAttr, AttributeSet playbackAttrs) {
    ...
    if (mView != null) {
      mView.setOnClickListener(componentListener);
    }
  }
