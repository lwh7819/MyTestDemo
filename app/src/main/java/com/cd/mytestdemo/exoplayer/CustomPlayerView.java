 ...
 * during playback, and displays playback controls using a {@link CustomPlayerControlView}.
 *
 ...
 *       <ul>
 *         <li>Corresponding method: None
 *         <li>Default: {@code R.id.custom_exo_player_view}
 *       </ul>
 *   <li><b>{@code controller_layout_id}</b> - Specifies the id of the layout resource to be
 *       inflated by the child {@link CustomPlayerControlView}. See below for more details.
 *       <ul>
 *         <li>Corresponding method: None
 *         <li>Default: {@code R.id.exo_player_control_view}
 *       </ul>
 *   <li>All attributes that can be set on a {@link CustomPlayerControlView} can also be set on a
 *       PlayerView, and will be propagated to the inflated {@link CustomPlayerControlView} unless the
 ...
 * you can define {@code custom_exo_player_viewer_view.xml} layout files in your application {@code res/layout*}
 ...
 *       {@link CustomPlayerControlView}. Ignored if an {@code exo_controller} view exists.
 *       <ul>
 *         <li>Type: {@link View}
 *       </ul>
 *   <li><b>{@code exo_controller}</b> - An already inflated {@link CustomPlayerControlView}. Allows use
 *       of a custom extension of {@link CustomPlayerControlView}. Note that attributes such as {@code
 ...
 *       <ul>
 *         <li>Type: {@link CustomPlayerControlView}
 *       </ul>
 ...
 *
 * Defining your own {@code custom_exo_player_view.xmliew.xml} is useful to customize the layout of PlayerView
 ...
 * custom_exo_player_viewer_view.xml} for only the instance on which the attribute is set.
 */
public class CustomPlayerView extends FrameLayout {
  ...
  public CustomPlayerView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    int controllerShowTimeoutMs = CustomPlayerControlView.DEFAULT_SHOW_TIMEOUT_MS;
   ...
   * @param oldCustomPlayerView The old view to detach from the player.
   * @param newCustomPlayerView The new view to attach to the player.
   */
  public static void switchTargetView(
      @NonNull Player player,
      @Nullable CustomPlayerView oldCustomPlayerView,
      @Nullable CustomPlayerView newCustomPlayerView) {
    if (oldCustomPlayerView == newCustomPlayerView) {
      return;
    }
    ...
    if (newCustomPlayerView != null) {
      newCustomPlayerView.setPlayer(player);
    }
    if (oldCustomPlayerView != null) {
      oldCustomPlayerView.setPlayer(null);
    }
  }
   ...
   * {@link #switchTargetView(Player, CustomPlayerView, CustomPlayerView)} rather than this method. If you do
  ...
  /**
   * Set the {@link CustomPlayerControlView.VisibilityListener}.
   *
   * @param listener The listener to be notified about visibility changes.
   */
  public void setControllerVisibilityListener(CustomPlayerControlView.VisibilityListener listener) {
    Assertions.checkState(controller != null);
  ...
  public void setControlDispatcher(@Nullable PlaybackControlView.ControlDispatcher controlDispatcher) {
    Assertions.checkState(controller != null);
